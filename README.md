...
(It does the same thing as the Installation - Manual instructions on the page referenced above. I was doing it manually again and thought about automating it via Github's API. I also learnt something about streams and pipes. It's here because someone else might find it useful or offer useful advice on how to make it better.)

### Prerequisites
- Linux
- A newish version of Node
- Steam
...
Options:
- `--delete-earlier` can be used to delete prior versions of Proton-GE already installed
- `--flatpak` should be used if Steam was installed as a flatpak
